...
class HhruSpider(scrapy.Spider):
    ...
    start_urls = ['https://hh.ru/search/vacancy?fromSearchLine=true&text=python&area=1347&search_field=description&search_field=company_name&search_field=name',
    ...
    def vacancy_parse(self, response:HtmlResponse):
        name = response.xpath("//h1[@data-aq='vacancy-title']/text").get()
